...
export interface QueueEntry {
  id: string
  riderName: string
  riderName2?: string  // for V3 dual-rider
}
...
export interface Lap {
  ...
  riderId: string
  riderName: string
  riderId2?: string       // V3 dual-rider
  riderName2?: string     // V3 dual-rider
  lapNumber: number
  distanceKm: number
  durationMs: number
...
export interface Transition {
  ...
  incomingRiderId2?: string
  incomingRiderName2?: string
  outgoingRiderId?: string
  outgoingRiderName?: string
  outgoingRiderId2?: string
  outgoingRiderName2?: string
  startTimestamp: string
  endTimestamp?: string
  durationMs?: number
}
...
export interface BikeState {
  ...
  currentRiderId2?: string      // V3 dual-rider
  currentRiderName2?: string    // V3 dual-rider
  isDualRider?: boolean         // true for V3
  maintenanceMode?: boolean
  maintenanceStartTimestamp?: string
  pausedLapElapsedMs?: number   // elapsed ms at the moment maintenance was activated
  currentLapStartTimestamp?: string
...
export interface LapAlertSettings {
  V1: number
  V2: number
  V3: number
}
...
export interface HeaderStatConfig {
  ...
  showTotalLaps?: boolean
  showTotalKm?: boolean
  showV1Laps?: boolean; showV2Laps?: boolean; showV3Laps?: boolean
  showV1Km?: boolean;   showV2Km?: boolean;   showV3Km?: boolean
}
...
export interface LapAlertEnabled {
  V1: boolean
  V2: boolean
  V3: boolean
}
...
export interface RaceSettings {
  relayAlertThresholdMs: number  // legacy fallback
